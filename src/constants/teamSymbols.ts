const teamSymbolMap: { [key: string]: any } = {
  ...
  nc: require('../assets/simbols/nc_simbol.png'),
  sl: require('../assets/simbols/sl_simbol.png'),
  ss: require('../assets/simbols/ss_simbol.png'),
  ds: require('../assets/simbols/ds_simbol.png'),
  he: require('../assets/simbols/he_simbol.png'),
};

export default teamSymbolMap;